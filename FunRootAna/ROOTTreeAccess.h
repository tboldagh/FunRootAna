...
#ifndef ROOTTreeAccess_h
#define ROOTTreeAccess_h
#include <string>
#include <limits>
#include <type_traits>
#include "TTree.h"
...
class ROOTTreeAccess {
public:
	ROOTTreeAccess(TTree* t, size_t start = 0, size_t max = std::numeric_limits<size_t>::max()) : m_current(start), m_tree(t) {
